"""
Django settings for Main_Certificate_May project.
...
INSTALLED_APPS = [
    ...
    'ckeditor',
    "сontact_us.apps.ContactUsConfig",
]
...
ROOT_URLCONF = 'Main_Certificate_May.urls'
...
WSGI_APPLICATION = 'Main_Certificate_May.wsgi.application'
